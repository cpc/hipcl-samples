...
public:
  ...
  Subfacet_Adjacency()
      : event(MC_Subfacet_Adjacency_Event::Adjacency_Undefined), current(),
        adjacent(), neighbor_index(-1), neighbor_global_domain(-1),
        neighbor_foreman(-1) {}
};
...
public:
  ...
  MC_Facet_Adjacency() : subfacet(), num_points(3) {
...
public:
  ...
  MC_Facet_Adjacency_Cell()
      : num_facets(24), _facet(0), num_points(14), _point(0) {}
