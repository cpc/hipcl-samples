...
class Isotope {
public:
  Isotope() : _gid(0), _atomFraction(0) {}
...
public:
  ...
  Material() : _name("0"), _mass(1000.0) {}

  Material(const std::string &name) : _name(name), _mass(1000.0) {}

  Material(const std::string &name, double mass) : _name(name), _mass(mass) {}
...
public:
  ...
  // Store the cross sections and reactions by isotope, which stores it by
  // species
