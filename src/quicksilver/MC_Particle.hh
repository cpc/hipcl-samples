...
public:
  ...
  // unique identifier used to identify and track individual particles in the
  // simulation
  uint64_t identifier;
...
public:
  ...
  HOST_DEVICE_CUDA
  void Move_Particle(const DirectionCosine &direction_cosine,
  ...
  HOST_DEVICE_CUDA
  DirectionCosine *Get_Direction_Cosine() { return &this->direction_cosine; }

  HOST_DEVICE_CUDA
  MC_Vector *Get_Velocity() { return &this->velocity; }
};
...
//----------------------------------------------------------------------------------------------------------------------
inline void
MC_Particle::Move_Particle(const DirectionCosine &my_direction_cosine,
                           const double distance) {
