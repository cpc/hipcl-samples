...
// Tuple to record which particles need to be sent to which neighbor process
// during tracking
...
private:
  // The send queue - stores particle index and neighbor index for any particles
  // that hit (TRANSIT_OFF_PROCESSOR)
