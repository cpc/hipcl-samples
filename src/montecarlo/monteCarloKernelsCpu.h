...
float discretizationDriftCpu(float t0, float x0, float dt,
                             monteCarloOptionStruct optionStruct);

float localVoltLocVolCpu(float t, float underlyingLevel,
                         monteCarloOptionStruct optionStruct);

float processDiffCpu(float t, float x, monteCarloOptionStruct optionStruct);

float discDiffCpu(float t0, float x0, float dt,
                  monteCarloOptionStruct optionStruct);

float stdDeviationCpu(float t0, float x0, float dt,
                      monteCarloOptionStruct optionStruct);

float applyCpu(float x0, float dx);

float discDriftCpu(float t0, float x0, float dt,
                   monteCarloOptionStruct optionStruct);

float processEvolveCpu(float t0, float x0, float dt, float dw,
                       monteCarloOptionStruct optionStruct);
...
void getPathCpu(float *path, size_t sampleNum, float dt, int numSample,
                monteCarloOptionStruct optionStruct);
...
void monteCarloGpuKernelCpu(float *samplePrices, float *sampleWeights,
                            float *times, float dt,
