...
void luHip(int n, DATA_TYPE POLYBENCH_2D(A,N,N,n,n), DATA_TYPE POLYBENCH_2D(A_outputFromGpu,N,N,n,n))
{
	DATA_TYPE* AGpu;
...
int main(int argc, char *argv[])
{
	...
	GPU_argv_init();
	luHip(n, POLYBENCH_ARRAY(A), POLYBENCH_ARRAY(A_outputFromGpu));
