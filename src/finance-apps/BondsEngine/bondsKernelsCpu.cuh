...
dataType cashFlowsAccruedAmountCpu(cashFlowsStruct cashFlows,
                                   ...
                                   bondsDateStruct settlementDate, int numLegs,
...
dataType fixedRateBondForwardSpotIncomeCpu(inArgsStruct inArgs, int bondNum,
...
dataType getCashFlowsYieldCpu(cashFlowsStruct cashFlows, dataType npv,
                              int dayCounter, int compounding,
                              dataType frequency,
                              bool includeSettlementDateFlows,
                              bondsDateStruct settlementDate,
                              bondsDateStruct npvDate, int numLegs,
                              dataType accuracy = 1.0e-10,
                              int maxIterations = 100, dataType guess = 0.05f);
